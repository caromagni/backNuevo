...
**URL de Swagger:** ``https://dev-backend.tareas.pjm.gob.ar/docs``
**URL de Swagger Productiva :** ``https://backend.tareas.pjm.gob.ar/docs``
...
Todas las solicitudes de API requieren autenticación usando JWT (JSON Web Tokens). Consulta la documentación de Swagger para obtener detalles sobre la autenticación y ejemplos de solicitudes.
