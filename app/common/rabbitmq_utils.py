...
def connect():        
                ...
                try:
                    ...
                    channel.queue_declare(queue='tareas_params', durable=True, passive=True)
                    ...
                    if e.reply_code == 404:
                        ...
                        channel = connection.channel()
                        channel.queue_declare(queue='tareas_params', durable=True)
...
class RabbitMQHandler:
    ...
    def callback(self, ch, method, properties, body):
        ...
        try:
            ...
            #self.process_message(json.loads(body.decode('utf-8')))
